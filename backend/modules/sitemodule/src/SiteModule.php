 ...
 * @copyright Copyright (c) 2020 Pennebaker
 */
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                $event->rules['get-csrf'] = 'site-module/default/get-csrf';
                $event->rules['get-gql-token'] = 'site-module/default/get-gql-token';
                $event->rules['get-field-options'] = 'site-module/default/get-field-options';
                $event->rules['get-form-layout'] = 'site-module/default/get-form-layout';
                $event->rules['form'] = 'freeform/api/form';
                $event->rules['get-hearts'] = 'site-module/default/get-hearts';
                $event->rules['add-heart'] = 'site-module/default/add-heart';
                $event->rules['remove-heart'] = 'site-module/default/remove-heart';
            }
        );
